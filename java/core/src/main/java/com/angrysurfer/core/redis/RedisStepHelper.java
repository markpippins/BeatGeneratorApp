...
@Getter
@Setter
public class RedisStepHelper {
    private static final Logger logger = Logger.getLogger(RedisStepHelper.class.getName());
    private final JedisPool jedisPool;
    private final ObjectMapper objectMapper;

    public RedisStepHelper(JedisPool jedisPool, ObjectMapper objectMapper) {
