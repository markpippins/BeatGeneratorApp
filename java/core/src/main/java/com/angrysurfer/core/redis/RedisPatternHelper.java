...
@Getter
@Setter
public class RedisPatternHelper {
    private static final Logger logger = Logger.getLogger(RedisPatternHelper.class.getName());
    private final JedisPool jedisPool;
    private final ObjectMapper objectMapper;
    private final RedisStepHelper stepHelper;

    public RedisPatternHelper(JedisPool jedisPool, ObjectMapper objectMapper) {
