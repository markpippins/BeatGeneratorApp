...
public class RedisSessionHelper {
    private static final Logger logger = Logger.getLogger(RedisSessionHelper.class.getName());
    private final JedisPool jedisPool;
    private final ObjectMapper objectMapper;
    private final RedisPlayerHelper playerHelper;
    private final CommandBus commandBus = CommandBus.getInstance();

    public RedisSessionHelper(JedisPool jedisPool, ObjectMapper objectMapper) {
