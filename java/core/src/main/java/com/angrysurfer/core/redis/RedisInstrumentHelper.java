...
@Getter
@Setter
public class RedisInstrumentHelper {
    private static final Logger logger = Logger.getLogger(RedisInstrumentHelper.class.getName());
    private final JedisPool jedisPool;
    private final ObjectMapper objectMapper;

    public RedisInstrumentHelper(JedisPool jedisPool, ObjectMapper objectMapper) {
