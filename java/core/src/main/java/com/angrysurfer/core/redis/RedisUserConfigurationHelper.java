...
@Getter
public class RedisUserConfigurationHelper {
    private static final Logger logger = Logger.getLogger(RedisUserConfigurationHelper.class.getName());
    private final JedisPool jedisPool;
    private final ObjectMapper objectMapper;

    public RedisUserConfigurationHelper(JedisPool jedisPool, ObjectMapper objectMapper) {
