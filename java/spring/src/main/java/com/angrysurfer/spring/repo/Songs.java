...
public interface Songs extends JpaRepository<ISong, Long> {
    ...
    ISong getNextSong(@Param("currentSongId") Long currentSongId);
    ...
    ISong getPreviousSong(@Param("currentSongId") Long currentSongId);
