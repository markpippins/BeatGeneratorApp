...
//     private Next<Song> songForward = (Long id) -> getSongRepository().getNextSong(id);
//     private Prior<Song> songBack = (Long id) -> getSongRepository().getPreviousSong(id);
//     private Max<Song> songMax = () -> getSongRepository().getMaximumSongId();
//     private Min<Song> songMin = () -> getSongRepository().getMinimumSongId();
...
//     private Max<Ticker> tickerMax = () -> getTickerRepo().getMaximumTickerId();
//     private Min<Ticker> tickerMin = () -> getTickerRepo().getMinimumTickerId();
