...
public class BeatsConfigConverter {
    private static final Logger logger = LoggerFactory.getLogger(BeatsConfigConverter.class);
    private final ObjectMapper jsonMapper;
    private final XmlMapper xmlMapper;

    public BeatsConfigConverter() {
    ...
    public static void main(String[] args) {
        BeatsConfigConverter converter = new BeatsConfigConverter();
