...
public class OffsetSequencerPanel2 extends JPanel implements IBusListener {
     ...
     */
    public OffsetSequencerPanel2(MelodicSequencer sequencer) {
     ...
     */
    public OffsetSequencerPanel2(DrumSequencer sequencer) {
        this.sequencer = sequencer;
    ...
    private void initialize() {
        ...
        UIHelper.setWidgetPanelBorder(this, "Sequence Length Adjustment");
