...
public class MuteSequencerPanelAttempt extends JPanel implements IBusListener {
    private static final Logger logger = LoggerFactory.getLogger(MuteSequencerPanelAttempt.class);
     ...
     */
    public MuteSequencerPanelAttempt(MelodicSequencer sequencer) {
     ...
     */
    public MuteSequencerPanelAttempt(DrumSequencer sequencer) {
        this.sequencer = sequencer;
