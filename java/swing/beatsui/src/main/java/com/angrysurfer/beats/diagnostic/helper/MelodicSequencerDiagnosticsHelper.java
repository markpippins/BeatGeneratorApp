 ...
 */
public class MelodicSequencerDiagnosticsHelper {
    ...
    public DiagnosticLogBuilder runMelodicSequencerDiagnostics() {
        ...
        try {
            ...
            List<MelodicSequencer> sequencers = MelodicSequencerManager.getInstance().getAllSequencers();
    ...
    public DiagnosticLogBuilder testPatternOperations() {
        ...
        try {
            ...
            com.angrysurfer.core.model.Direction originalDirection = data.getDirection();
            log.addIndentedLine("Original direction: " + originalDirection, 1);
            
            // Change direction
            com.angrysurfer.core.model.Direction newDirection = com.angrysurfer.core.model.Direction.BACKWARD;
