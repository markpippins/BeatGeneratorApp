...
public class ToggleDialPanel extends JPanel {
    ...
    private List<ChangeListener> dialChangeListeners = new ArrayList<>();
    private List<ActionListener> toggleActionListeners = new ArrayList<>();
...
// toggleDial.setKnobColor(ColorUtils.getDialColor("reverb"));
