...
public class SoundPanel extends JPanel {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SoundPanel.class);
     ...
     */
    public SoundPanel(Player player) {
    ...
    private void initializeFromInstrument() {
        try {
            ...
            if (instrument != null) {
                ...
                Integer preset = instrument.getCurrentPreset();
    ...
    private void applyProgramChange(int bank, int program) {
        if (instrument != null && player != null) {
            try {
                ...
                instrument.setCurrentPreset(program);
                instrument.setBankIndex(bank);
                
                // Get the currently selected soundbank
                if (currentSoundbankName != null) {
                    instrument.setSoundbankName(currentSoundbankName);
                }
                ...
                boolean isInternalSynth = Boolean.TRUE.equals(instrument.getInternal());
                ...
                if (isInternalSynth) {
                    ...
                    if (synthManager != null) {
                        ...
                        synthManager.applyPresetChange(instrument, channel, program);
                        ...
                        if (commandBus != null) {
                            commandBus.publish(Commands.PRESET_CHANGED, this, instrument);
                        }
                    } else {
                    ...
                    if (instrument.getDevice() != null) {
                        ...
                        if (bank > 0) {
                            ...
                            // Bank LSB (CC#32)
                            instrument.controlChange(channel, 32, bank);
                ...
                if (manager != null && instrument.getId() != null) {
                    manager.updateInstrument(instrument);
            ...
            logger.warn("Cannot apply program change - instrument={}, player={}", instrument, player);
        }
    }
