...
public abstract class PolyPanel extends JPanel implements IBusListener {
    ...
    abstract void updateDialsForSelectedPad();
        ...
        switch (action.getCommand()) {
            ...
            case Commands.TRANSPORT_START -> {
                ...
                if (selectedPadIndex >= 0) {
                    ...
                    refreshDialsForPad(selectedPadIndex); // Add this line
                }
            }
            ...
            case Commands.DRUM_SEQUENCE_LOADED, Commands.DRUM_SEQUENCE_CREATED,
                ...
                if (selectedPadIndex >= 0) {
                    ...
                    refreshTriggerButtonsForPad(getSelectedPadIndex());
...
//            }
    ...
    abstract void refreshDialsForPad(int selectedPadIndex);
    ...
    JPanel createAccentPanel(int index) {
    ...
    JPanel getTriggerJPanel(int index) {
    ...
    void toggleStepForActivePad(int stepIndex) {
        if (selectedPadIndex >= 0) {
            ...
            if (isNowActive) {
                toggleDialsForActivePad(stepIndex);
            }
    ...
    abstract void toggleDialsForActivePad(int stepIndex);
