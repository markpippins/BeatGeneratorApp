 ...
 */
public class PlayerManagerDiagnosticsHelper {
    ...
    public DiagnosticLogBuilder testPlayerManager() {
        ...
        try {
            ...
            try {
                ...
                for (Player player : playerCache.values()) {
                    if (player.isDrumPlayer() && (player.getChannel() == null || player.getChannel() != 9)) {
