 ...
 */
public class ReceiverManagerDiagnosticsHelper {
    ...
    public DiagnosticLogBuilder testReceiverManager() {
        ...
        try {
            ...
            if (!deviceNames.isEmpty()) {
                ...
                // Get a device
                MidiDevice device = DeviceManager.getMidiDevice(testDevice);
     ...
     */
    private void testGervillReceiver(DiagnosticLogBuilder log, ReceiverManager manager) {
        try {
            ...
            // Get receiver
            Receiver receiver = manager.getOrCreateReceiver("Gervill", gervill);
