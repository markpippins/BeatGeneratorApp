...
public class RedisDiagnosticsHelper {
    ...
    public static DiagnosticLogBuilder runAllRedisDiagnostics() {
        ...
        try {
            ...
            SessionDiagnosticsHelper sessionHelper = new SessionDiagnosticsHelper();
            ...
            UserConfigDiagnosticsHelper configHelper = new UserConfigDiagnosticsHelper();
            ...
            InstrumentDiagnosticsHelper instrumentHelper = new InstrumentDiagnosticsHelper();
