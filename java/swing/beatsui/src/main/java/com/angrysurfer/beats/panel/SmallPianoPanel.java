...
// public class SmallPianoPanel extends JPanel {
...
//                     this,
//                     new StatusUpdate("Small Piano Panel", "Playing", "Playing midi note: " + note));
...
//                     Commands.STATUS_UPDATE,
//                     this,
//                     new StatusUpdate("Small Piano Panel", "Holding", "Holding midi note: " + note));
//             heldNotes.add(note);
//             highlightKey(note);
//             playNote(note);
