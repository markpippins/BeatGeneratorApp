...
public class AppFrame extends JFrame {
    ...
    private void setupToolBar() {
        ...
        // Edit controls with simple characters
        JButton addBtn = createToolbarButton("+", "Add");
        JButton subtractBtn = createToolbarButton("-", "Subtract");

        toolBar.add(addBtn);
        toolBar.add(subtractBtn);
    ...
    private JPanel createBeatsPanel() {
        ...
        beatsPanel.add(pianoPanel, BorderLayout.SOUTH);
